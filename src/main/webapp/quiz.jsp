...
<div class="quiz_box">
            ...
            <form action="quiz" method="post">
                <div class="choices-grid">
                    <c:forEach var="choice" items="${choices}">
                        <button type="submit" name="answer" value="${choice}" class="choice-button">${choice}</button>
                    </c:forEach>
                </div>
    ...
    <div class="image_container">
        ...
        <div id="fruit-container">
            <img id="random-fruit" src="${fruitImage}" alt="果物" style="width: 60px; height: 60px; position: relative; top: 30px;">
        </div>
    </div>
</div>
